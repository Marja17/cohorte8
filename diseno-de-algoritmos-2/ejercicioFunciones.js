...
else vacio porque es la que te da opciones restantes 
*/

const precio = parseInt(prompt("Introduce el precio"));

 if (precio >0 && precio <100) {
      document.write ("tu descuentos es de:" + precio*.90);
    } 
    else if (precio >= 100 && precio <200) {
        document.write ("tu descuentos es de:" + precio*.80);
    }
    else 
    {
        document.write ("tu descuentos es de:" + precio*.70) 
